                        ...
                        <div class="card-block">
                            ...
                            <div class="form-bottom">
                                <div class="text-center">
                                    <div>
                                        <label>Are you Social! Login with any social accounts</label>
                                    </div>
                                ...
                                <form role="form"  class="login-form" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                        <label for="email" class="custom-sr-only" for="form-username">E-Mail</label>
                                    ...
                                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                        <label for="password" class="custom-sr-only" for="form-password">Password</label>
                                    ...
                                    <a href="{{ route('password.request') }}" class="pull-right">Forget password ?</a>
                                </form>
                            </div>
                        </div>
                    </div>
