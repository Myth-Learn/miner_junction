                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    ...
                    <td align="left" style="padding:50px 50px 50px 50px">
                      <img src="{{ $message->embed(public_path() . '/images/logo.png') }}" style="width:100px" /><p style="color:#262626; font-size:24px; text-align:left; font-family: Verdana, Geneva, sans-serif">
                       <strong>Dear {{ $full_name }}</strong>,</p>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">Thank you for showing interest in India's very first bitcoin trading exchange platform . We will let you know the updates about the same. Wait for the most exciting automated trade and be a trader with Miner Junction<br />
                      </p>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">Your subscription code is <strong>{{ $code }}</strong>.</p>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">Kindly use it at the time of registration to avail discount.</p>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">
                        <br />
                        Best Regards, <br />
                        Miner Junction & Team</p></td>
                  </tr>
                </table>
